...
CREATE TABLE blog (
  ...
  ALTER TABLE blog ADD COLUMN slug VARCHAR(200);
  ALTER TABLE blog ADD COLUMN metaTitle VARCHAR(300) NOT NULL DEFAULT 'My Blog';
  ALTER TABLE blog ADD COLUMN privacy VARCHAR(100) DEFAULT 'public';
